...
tk_text1 = t.Label(f4,text=25*"=")
tk_text1.pack(side="top")

tk_text2 = t.Label(f4,text=25*"=")
tk_text2.pack(side="top")

tk_text3 = t.Label(f4,text=25*"=")
tk_text3.pack(side="top")

tk_text4= t.Label(f4,text=25*"=")
tk_text4.pack(side="top")

tk_text5 = t.Label(f4,text=25*"=")
tk_text5.pack(side="top")

tk_text6 = t.Label(f4,text=25*"=")
tk_text6.pack(side="top")

tk_text7 = t.Label(f4,text=25*"=")
tk_text7.pack(side="top")

tk_text8= t.Label(f4,text=25*"=")
tk_text8.pack(side="top")

tk_text9 = t.Label(f4,text=25*"=")
tk_text9.pack(side="top")

tk_text10 = t.Label(f4,text=25*"=")
